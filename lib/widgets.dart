...
class PlaybackControls extends StatelessWidget {
  ...
  PlaybackControls({required this.animation_controller, required this.sound_player, this.play_icon_size = 35});
...
class SimpleSoundPlayer extends StatefulWidget {
  ...
  SimpleSoundPlayer({required this.name, required this.contents, this.position_colour});
